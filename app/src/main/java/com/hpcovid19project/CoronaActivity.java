...
import com.hpcovid19project.Adapter.CoronaAdapter;
import com.hpcovid19project.Adapter.FAQAdapter;
import com.hpcovid19project.Models.Corona;
import com.hpcovid19project.Models.FAQ;
import com.hpcovid19project.Models.Persons;
        ...
        JsonObjectRequest request1 = new JsonObjectRequest(Request.Method.GET,url1, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONObject jsonObject = response.getJSONObject("Himachal Pradesh").getJSONObject("districtData");
